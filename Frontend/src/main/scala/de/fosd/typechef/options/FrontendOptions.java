...
public class FrontendOptions extends CAnalysisOptions implements ParserOptions {
    ...
    public List<Options.OptionGroup> getOptionGroups() {
        ...
        r.add(new OptionGroup("General processing options (lexing, parsing, type checking, interfaces; select only highest)", 10,
                ...
                new Option("writeProjectInterface", LongOpt.REQUIRED_ARGUMENT, F_PROJECTINTERFACE, null, "Writes interface for a complete casestudy." ),
    ...
    public String getSerializedTUnitFileExtension() {
        return serializeTUnitFileExtension;
    }

    public String getSerializedTUnitFilename() {
        return outputStem + getSerializedTUnitFileExtension();
    }
